...
# removing the '--normalize' argument pravents state space vectors from being normalized. 
os.system(f'"{sys.executable}" -m src.data.gen_lander_dataset --training_seq_len 12 --normalize')