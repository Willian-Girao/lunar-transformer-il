...
os.system(f'"{sys.executable}" -m src.training.train_transformer --env {args.env} --transformer_json noise_normal_transformer.json --train_json training_config_noise_normal.json')