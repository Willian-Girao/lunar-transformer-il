...
<figure style="display: inline-block; text-align: center;">
  ...
  <p align="center"><i>Figure 1: Expert piloting the lander (R = 276).</i></p>
</figure>

<figure style="display: inline-block; text-align: center;">
  <p align="center"><img src="data/media/transformer_pilot.gif" alt="Transformer Pilot" width="75%"></p>
  <p align="center"><i>Figure 2: Transformer piloting the lander (R = 285).</i></p>
</figure>
...
- **Hyperparameter optimization (HPO)**:
  - A [coarse grained HPO](./architecture_search.md) is done to select the baseline network architecture.
  - A [finer grained HPO](./nni_hpo.md) is then performed using [NNI](https://nni.readthedocs.io/).
